...
module.exports = {
    ...
    permission: Discord.PermissionFlagsBits.KickMembers || Discord.PermissionFlagsBits.Administrator,
    dm: false,
    category : "Modération",
    options: [
        {
    ...
    async run(bot, message, args) {
        ...
        if((await message.guild.bans.fetch()).get(user.id)) return message.reply("Ce membre est déjà kick du serveur !")
